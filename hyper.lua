...
BoxScripts:AddButton({
    ...
    BoxScripts:AddButton({ Text = "Dovi Hub", Func = function()
        pcall(function() setclipboard("qb7HLcqv2o5rdNzpeFbY") end)
        Library:Notify({ Title = bypassText("Dovi Hub"), Content = "Copied Key", Time = 3 })
        task.delay(2, function()
...
local BoxCredits = Tabs.ChangeLogs:AddLeftGroupbox("HyperTeam", "crown")
